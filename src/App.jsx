// src/App.jsx — Generated by VIA for: build a full stack hospital appointmentbooking system where patientscan book appointments with doctors, view schedules, and save records with data stored
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build A Full Stack Hospital Appointmentbooking System Where</span>
            </Link>
            <div className="flex items-center gap-3">
              ...
              <Link to="/new" className="btn-primary text-sm py-2 px-4">+ Book Appointment</Link>
            </div>
          </div>
        </div>
      </nav>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build A Full Stack Hospital Appointmentbooking System Where</h1>
          <p className="text-gray-500 mt-1 text-sm">Powered by VIA — Autonomous AI Platform</p>
        </div>
        <Link to="/new" className="btn-primary">+ Book Appointment</Link>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <StatCard title="Total Appointments" value={stats?.total ?? 0} loading={loading} color="blue" />
        <StatCard title="Scheduled" value={stats?.active ?? 0} loading={loading} color="green" />
        <StatCard title="Departments" value={"4+"} loading={loading} color="purple" />
      </div>
      <div className="card">
        ...
        {loading ? <Spinner /> : items.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Link to="/new" className="btn-primary inline-block">+ Book Appointment</Link>
          </div>
        ) : (
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/new" className="btn-primary whitespace-nowrap">+ Book Appointment</Link>
        </div>
      </div>
      {filtered.length === 0 ? (
        <div className="card text-center py-20">
          <p className="text-5xl mb-4">🏥</p>
          <p className="text-gray-400 text-lg mb-6">No appointments yet</p>
          <Link to="/new" className="btn-primary inline-block">+ Book Appointment</Link>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50/80 border-b border-gray-100">
              <tr>
                ...
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Doctor</th><th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Dept</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {filtered.map(item => (
                <tr key={item.id ?? item._id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-5 py-4 text-gray-600">{item.doctor_name || '—'}</td><td className="px-5 py-4 text-gray-600">{item.department || 'General'}</td>
...
function ItemFormPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="card">
        <h1 className="text-2xl font-display font-bold text-gray-900 mb-6">Book Appointment</h1>
